...
# Last modified: 2015-10-20 20:15:55 +0200
#
...
def main(argv):
    ...
    with cf.ThreadPoolExecutor(max_workers=os.cpu_count()) as tp:
        fl = [tp.submit(runmp3, t) for t in tracks]
...
def runmp3(tinfo):
    ...
    Returns:
        A tuple containing the Trackinfo and the return value of lame.
    """
    args = ['lame', '-S', '--preset', 'standard', '--tt', tinfo.title,
            '--ta', tinfo.artist, '--tl', tinfo.album, '--tn',
            '{:02d}'.format(tinfo.num), tinfo.ifname, tinfo.ofname]
