...
# Last modified: 2016-02-07 17:13:55 +0100
...
case $1 in
    vod) echo "Encoding for video on demand.";
        FP="-c:v libvpx-vp9 -threads 4 -pass 1 -b:v 1000K -g 250 -speed 4 -tile-columns 6 -frame-parallel 1 -auto-alt-ref 1 -lag-in-frames 25 -an -f webm -y /dev/null";
    ...
    crq) echo "Encoding for constrained quality.";
         FP="-c:v libvpx-vp9 -threads 4 -pass 1 -b:v 1400k -crf 33 -g 250 -speed 4 -tile-columns 6 -frame-parallel 1 -auto-alt-ref 1 -lag-in-frames 25 -an -f webm -y /dev/null";
    ...
    con) echo "Encoding for constant quality.";
         FP="-c:v libvpx-vp9 -pass 1 -b:v 0 -crf 25 -g 250 -speed 4 -tile-columns 6 -frame-parallel 1 -auto-alt-ref 1 -lag-in-frames 25 -an -f webm -y /dev/null";
    ...
    bq) echo "Encoding for best quality.";
         FP="-c:v libvpx-vp9 -threads 1 -pass 1 -b:v 1000K -g 250 -speed 4 -tile-columns 0 -frame-parallel 0 -auto-alt-ref 1 -lag-in-frames 25 -g 9999 -aq-mode 0 -an -f webm -y /dev/null";
